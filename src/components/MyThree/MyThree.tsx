...
import style from './MyThree.module.css'

export type MyThreeProps = {
...
const MyThree: React.FC<MyThreeProps> = () => {
    ...
    useEffect(() => {
        ...
        if (canvas) {
            ...
            function cameraMovement(x: number, y: number, z: number) {
            ...
            function cameraRotation(x: number, y: number, z: number) {
